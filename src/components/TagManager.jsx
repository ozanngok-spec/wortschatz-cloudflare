...
export function TagManager({ tags = [], onUpdate }) {
  const th = useTheme();
  ...
  return (
    <div style={{ marginTop:14, paddingTop:14, borderTop:`1px solid ${th.border}` }}>
      <div style={{ fontSize:9, color:th.textFaint, letterSpacing:"0.12em", textTransform:"uppercase", marginBottom:8 }}>Themen</div>
      <div style={{ display:"flex", flexWrap:"wrap", gap:5, marginBottom:6 }}>
        ...
        {tags.length === 0 && <span style={{ fontSize:11, color:th.textFaint, fontStyle:"italic" }}>Noch keine Themen</span>}
      </div>
      <div style={{ display:"flex", gap:6 }}>
        <input
          ...
          placeholder="Thema hinzufügen… (z. B. reise)"
